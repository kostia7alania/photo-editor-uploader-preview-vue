<template>
    ...
    <div class="nav-btns">
      <div class="nav--left">
        <button title='Go to the previous deficiency. You can also press the left button on the keyboard'
          v-show="prevShow"
          v-if="!upload_mode" type="button"
          class="modal-buttons"
          @click="prevHandler">&#x2039; {{$t('nav-btns.Previous')}}
        </button>

      </div>
      <div class="nav--center">
        <button v-if="SHOW_TOGGLE_upload_mode" type="button"
          @click="TOGGLE_upload_mode"
          class="modal-buttons main-button"
          :class="upload_mode && 'main_button__upload_mode'">
          ...
          {{$t(upload_mode ? "nav-btns.Show-pictures" : "nav-btns.Upload-pictures")}}
        </button>
      </div>
      <div class="nav--right">
        <button
          title="Go to the next deficiency. You can also press the right button on the keyboard"
          v-if="!upload_mode" type="button"
          class="modal-buttons"
          v-show="nextShow" @click="nextHandler">
          {{$t('nav-btns.Next')}} &#x203A;
        </button>
      </div>
    </div>
